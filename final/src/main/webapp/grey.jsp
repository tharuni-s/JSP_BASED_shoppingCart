...
<div class="sidebar">
  ...
  <a href="#view.html"><i class="fa fa-fw fa-wrench"></i>Women T-shirts</a>
  <a href="#men.html"><i class="fa fa-fw fa-user"></i>Men T-shitrs</a>
  <a href="#kid.html"><i class="fa fa-fw fa-user"></i>Kids T-shitrs</a>
...
<div align="center">
    ...
    <button  class="btn btn-warning" name="out" value="check" >Check out</button>
